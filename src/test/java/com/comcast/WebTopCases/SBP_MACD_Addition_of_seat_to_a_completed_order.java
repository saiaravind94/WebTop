...
public class SBP_MACD_Addition_of_seat_to_a_completed_order extends DisconnectFlow {
	DataTable dataSet;
	String eMsg = "";
	
	
	Logger log = Logger.getLogger(SBP_MACD_Addition_of_seat_to_a_completed_order.class);
	...
	public void addNewUCSeatWithBundle() throws Exception {
		...
		try {
			...
			servicesPage.addItemOrBundle("Bundle", "CustomerLevel", "BVEUC10-19-Seat Based Unified Communication Seats 10-19 | 39.95", 1);
