...
'	Auto Attendant - with a Local TN ---->1
' ################################################################################

' EXAMPLE SIMON SITE1
'	1	Seat	No Seat	BW Anywhere	FN1712513950	BWAnyWhere	kesavan_rajamanickam@cable.comcast.com	New			No Hardware												
'	2	Seat	No Seat	Voice Portal	FN1712513951	VoicePortal	kesavan_rajamanickam@cable.comcast.com	New			No Hardware												
'	3	Seat	Standard Seat	Tech Admin User	FN1712513952	TABTNstdseat001	kesavan_rajamanickam@cable.comcast.com	New			Polycom VVX 310 HD												
'	4	Seat	UC Seat	Enterprise Admin User	FN1712513954	UCSeat003	kesavan_rajamanickam@cable.comcast.com	New			Polycom VVX 500 HD												
'	5	Seat	UC Seat	Standard User	FN1712513955	UCSeat001	kesavan_rajamanickam@cable.comcast.com	New			Polycom VVX 600 HD												

' New outpul file will be generated with AAPreProvision_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "\AAPreProvision_" & (SFOpportunityId + 1) & ".xlsm"
		
		commonFieldUpdates objWorkbook, curSheetName, "AAPreProvision_"
		
		' ##########################  AUTO ATENDENT   ######################################
		.Cells(getRowIdx(curSheetName, "Standard Seats"), columnIdxToUpdate).Value = 1
