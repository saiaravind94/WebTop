...
' New outpul file will be generated with BVE_BCP_CordlessOrder_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "\BVE_BCP_CordlessOrder_" & (SFOpportunityId + 1) & ".xlsm"
		
		BCPSOACommonFieldUpdate_V1_44 objWorkbook, curSheetName, "BVE_BCP_CordlessOrder_", uniqueMailId
		' ----------------------------------------------------------------------------------------------------------------------
