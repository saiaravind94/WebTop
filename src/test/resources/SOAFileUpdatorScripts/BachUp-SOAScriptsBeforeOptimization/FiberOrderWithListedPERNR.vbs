...
' New outpul file will be generated with FiberOrderWithListedPERNR_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "\FiberOrderWithListedPERNR_" & (SFOpportunityId + 1) & ".xlsm"
		
		BCPSOACommonFieldUpdate_V1_44 objWorkbook, curSheetName, "FiberOrderWithListedPERNR_", mailIdList		
		'*****************************************************************************************************
		.Cells(getRowIdx(curSheetName, "Site Type* :"), columnIdxToUpdate).Value = "Standard"
		.Cells(getRowIdx(curSheetName, "Sales Rep PERNR:"), 2).value = "33333333"
		'*****************************************************************************************************		
