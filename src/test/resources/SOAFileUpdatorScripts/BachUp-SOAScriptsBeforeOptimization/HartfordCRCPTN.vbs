...
'	3	Seat	UC Seat	Tech Admin User	FN1722219032	TABTNstdseat001	kesavan_rajamanickam@comcast.com	New			Polycom VVX 310 HD												
'	4	Seat	UC Seat	Enterprise Admin User	FN1722219034	STDSeat002	kesavan_rajamanickam@comcast.com	New			Polycom VVX 310 HD												
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		BCPSOACommonFieldUpdate_V1_44 objWorkbook, curSheetName, "HartfordCRCPTN_", UniqueMailId
		'--------------------------------------------------------------------------------------------------------------------------------------------
