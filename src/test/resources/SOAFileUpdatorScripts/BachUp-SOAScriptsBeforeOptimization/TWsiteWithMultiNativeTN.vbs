...
'	3	Seat	UC Seat	Tech Admin User	FN2017297355	TABTNstdseat001	kesavan_rajamanickam@comcast.com	New			Polycom VVX 310 HD												
'	4	Seat	UC Seat	Tech Admin Only User	FN2017297357	TAOTNstdseat002	kesavan_rajamanickam@comcast.com	New			Polycom VVX 310 HD												
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		BCPSOACommonFieldUpdate_V1_44 objWorkbook, curSheetName, "TWsiteWithMultiNativeTN_", UniqueMailId
		'--------------------------------------------------------------------------------------------------------------------------
