...
' New outpul file will be generated with BCP_PERNRValidationON_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "\BCP_PERNRValidationON_" & (SFOpportunityId + 1) & ".xlsm"
		
		BCPSOACommonFieldUpdate_V1_44 objWorkbook, curSheetName, "BCP_PERNRValidationON_", mailIdList
		
		'*****************************************************************************************************
		.Cells(getRowIdx(curSheetName, "Site Type* :"), columnIdxToUpdate).Value = "Standard"
		.Cells(getRowIdx(curSheetName, "Sales Rep PERNR:"), 2).value = "22222222"
		'*****************************************************************************************************
