...
'	3	Seat	UC Seat	Tech Admin User	TABTNstdseat001	LN2017297355	LN2017297355@comcast.com	New			Polycom VVX 310 HD												
'	4	Seat	UC Seat	Enterprise Admin User	STDSeat002	LN2017297357	LN2017297357@comcast.com	New			Polycom VVX 310 HD												
...
' New outpul file will be generated with LRHWith3SLAndClearsExtn_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "LRHWith3SLAndClearsExtn_" & (SFOpportunityId + 1) & ".xlsm"

		BCPSOACommonFieldUpdate_V1_44 objWorkbook, curSheetName, "LRHWith3SLAndClearsExtn_", UniqueMailId
