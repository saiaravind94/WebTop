...
' New outpul file will be generated with MACD_SBP_STD_MultiSite_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "MACD_SBP_MultiSite_STD_" & (SFOpportunityId + 2) & ".xlsm"
		multiSiteOrderCommonFieldsUpdate objWorkbook, curSheetName, "MACD_SBP_MultiSite_STD_"
