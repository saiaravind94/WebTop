...
' New outpul file will be generated with ActiveAndInActiveAA_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "\ActiveAndInActiveAA_" & (SFOpportunityId + 1) & ".xlsm"
		
		BCPSOACommonFieldUpdate_V1_44 objWorkbook, curSheetName, "ActiveAndInActiveAA_", mailIdList
