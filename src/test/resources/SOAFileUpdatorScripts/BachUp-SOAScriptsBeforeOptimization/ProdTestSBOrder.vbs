...
'	3	Seat	Standard Seat	Tech Admin User	FN7125113662	TABTNstdseat001	Kesavan_Rajamanickam@cable.comcast.com	New			Polycom VVX 310 HD												
'	4	Seat	Standard Seat	Enterprise Admin User	FN7125113663	EAStdSeat002	Kesavan_Rajamanickam@cable.comcast.com	New			Polycom VVX 410 HD												
...
' New outpul file will be generated with ProdTest_BSDQE_SB_Std_<MonthAndDate>_<UpdatedOppornityID>.xlsm pattern
...
Else
	Include Replace(SOAFolderPath, "WebTopSOADataFiles", "SOAFileUpdatorScripts") & "Utilities.vbs"
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "ProdTest_BSDQE_SB_Std_" & getMonthDate() & "_" & (SFOpportunityId + 1) & ".xlsm"

		commonFieldUpdatesForProdLBOrder objWorkbook, curSheetName, "ProdTest_BSDQE_SB_Std_"
...
Sub Include(yourFile)
  ...
  Set oFileBeingReadIn = oFSO.OpenTextFile(yourFile, 1)
