...
' This script will update the following In Seat Based order as per SOA Version V1.40
' ##############################################################################
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		BCPSOACommonFieldUpdate_V1_44 objWorkbook, curSheetName, "E911AddressWithUnit_", UniqueMailId
