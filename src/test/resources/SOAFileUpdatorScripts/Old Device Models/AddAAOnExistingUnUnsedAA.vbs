...
' New outpul file will be generated with AddAAOnExistingUnUnsedAA_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "AddAAOnExistingUnUnsedAA_" & (SFOpportunityId + 1) & ".xlsm"

		commonFieldUpdates objWorkbook, curSheetName, "AddAAOnExistingUnUnsedAA_"
