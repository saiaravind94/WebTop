...
' New outpul file will be generated with MissingLNBCPTrayValidations_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "\MissingLNBCPTrayValidations_" & (SFOpportunityId + 1) & ".xlsm"
		
		commonFieldUpdates objWorkbook, curSheetName, "MissingLNBCPTrayValidations_"
