...
' New outpul file will be generated with ProdTest_BSDQE_LB_Std_<MonthAndDate>_<UpdatedOppornityID>.xlsm pattern
...
Else
	...
	With objWorkbook.Worksheets(curSheetName)
		...
		newFileName = SOAFolderPath & "ProdTest_BSDQE_LB_Std_" & getMonthDate() & "_" & (SFOpportunityId + 1) & ".xlsm"

		commonFieldUpdatesForProdLBOrder objWorkbook, curSheetName, "ProdTest_BSDQE_LB_Std_"
